<div class="sidebar">
    ...
    @endcan
    @can('ver roles')
    <a href="{{ route('roles.index')}}" class="texto"><i class="bi bi-list-columns-reverse"></i><span class="TextoNav">Roles</span></a>
    @endcan
    @can('ver usuarios')
    <a href="{{ route('users.index')}}" class="texto"><i class="bi bi-list-columns-reverse"></i><span class="TextoNav">Usuarios</span></a>
    @endcan
    @can('ver departamentos')
    <a href="{{ route('departamentos.index')}}" class="texto"><i class="bi bi-list-columns-reverse"></i><span class="TextoNav">Departamentos</span></a>
    @endcan
    @can('ver secciones')
    <a href="{{ route('secciones.index')}}" class="texto"><i class="bi bi-list-columns-reverse"></i><span class="TextoNav">Secciones</span></a>
    @endcan
    ...
    onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
        ...
        <span class="TextoNav">Cerrar sesión</span>
    </a>
